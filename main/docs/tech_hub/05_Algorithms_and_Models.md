...
The current article figure below is generated by `main/scripts/generate_article_visuals.py` and saved in `research/img`. It should be treated as the technical contract for the GNN explanation in Help and in the IEEE SMC paper.
